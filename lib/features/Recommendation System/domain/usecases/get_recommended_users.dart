...
class GetRecommendedUsers {
  ...
  GetRecommendedUsers({
    required this.hobbyCategoryRepository,
    required this.firestoreRepository,
  });

  //* Uncomment to add bots
  // final random = Random();

  Future<List<UserEntity>> call(
      UserEntity user, List<String> sortValues) async {
    //* Uncomment to add bots
    // List<UserEntity> otherUsersData = generateOtherUsersData();

    final Either<Failure, List<UserEntity>> usersResult =
        await firestoreRepository.getAllUsers();
    final Either<Failure, List<HobbyCategoryEntity>> hobbiesResult =
        await hobbyCategoryRepository.getHobbyCategories();

    if (usersResult.isLeft()) return [];
    ...
    //* Add bot list (otherUsersData) to allUsers
  ...
  // List<UserEntity> generateOtherUsersData() {
  ...
  //     List<HobbyModel> hobbies = generateHobbies(allHobbies);
